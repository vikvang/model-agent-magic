    ...
    try {
      ...
      if (Object.keys(keysToUpdate).length > 0) {
        ...
        if (existingData) {
          ...
          // Insert new record
          result = await supabase.from("user_api_keys").insert({
            user_id: user!.id,
            ...keysToUpdate,
          });
        }
        ...
        >
          <div className="flex items-center mb-6">
            <Avatar className="h-14 w-14 bg-[#FF6B4A] text-white mr-4 flex items-center justify-center">
              <AvatarFallback className="bg-[#FF6B4A] text-white font-semibold">
                {getInitials()}
              </AvatarFallback>
            </Avatar>
            <div>
          ...
          <div className="space-y-5">
            ...
            <div className="border border-[#2a2a2a] rounded-lg overflow-hidden bg-[#1a1a1a]">
              <h2 className="text-lg font-medium px-4 py-3 border-b border-[#2a2a2a]">
                Account Settings
              </h2>
              ...
              <div className="divide-y divide-[#2a2a2a]">
                ...
                >
                  <div className="flex items-center">
                    <User
                      size={18}
                      className="text-gray-400 mr-3 group-hover:text-[#FF6B4A] transition-colors duration-200"
                    />
                    <span>Personal Information</span>
                  </div>
                  <ChevronRight
                    size={18}
                    className="text-gray-500 opacity-60 group-hover:opacity-100 group-hover:text-white transition-all duration-200"
                  />
                </Button>
